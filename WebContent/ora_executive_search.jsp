...
<form action="ExecutiveSearch" method="post" name="f" id="form1" onsubmit="return Spry.Utils.submitForm(this, updateResponseDiv)">
<table class="tableform" width="400" border="0" cellpadding="3" cellspacing="0">

<tr><td align="right"><label id="home_search_q">Executive Name</label></td><td><input type="text" value="" id="executivename" name="executivename" tabindex="1"/></td></tr>
<tr><td align="right"><label id="home_search_q">Business Name</label></td><td><input type="text" value="" id="companyname" name="companyname" tabindex="2"/></td></tr>
<!-- 
<tr><td align="right"><label id="home_search_q"><a href="countrylookup.jsp" target="popup" onClick="wopen('countrylookup.jsp', 'popup', 640, 480); return false;">Country</a></label></td><td><input type="text" id="country" name="country" tabindex="3" value="" title="country"></td></tr>
-->
<tr><td align="right"><label id="home_search_q">Country</label></td><td><select name="country" tabindex="3">
	<option value=""></option>
...
<tr><td align="right"><label id="home_search_q">Number of Results to Return</label></td><td colspan="2"><input type="text" value="" id="maxresults" name="maxresults" tabindex="4"/></td></tr>
